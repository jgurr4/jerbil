 ...
 * the select, where, having, group by clause etc... Expressions can be columns, boolean expressions, numeric expressions,
 * Literals, subqueries etc... see: https://dev.mysql.com/doc/refman/8.0/en/expressions.html
